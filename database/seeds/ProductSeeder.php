...
//        }
        ...
        DB::table('products')->insert([
            ...
            'category' => 'movies',
            'thumbnail' => base64_encode(file_get_contents('https://lumiere-a.akamaihd.net/v1/images/avco_payoff_1-sht_v7_lg_32e68793.jpeg?region=0%2C0%2C1620%2C2400&width=600'))
        ]);
        ...
        DB::table('products')->insert([
            ...
            'category' => 'movies',
            'thumbnail' => base64_encode(file_get_contents('https://lumiere-a.akamaihd.net/v1/images/Star-Wars-Return-Jedi-VI-Poster_a10501d2.jpeg?region=12%2C9%2C618%2C982&width=600'))
        ]);
        DB::table('products')->insert([
            ...
            'category' => 'movies',
            'thumbnail' => base64_encode(file_get_contents('https://lumiere-a.akamaihd.net/v1/images/Star-Wars-Empire-Strikes-Back-V-Poster_878f7fce.jpeg?region=25%2C22%2C612%2C953&width=600'))
        ]);
        DB::table('products')->insert([
            'name' => 'A New Hope',
            'price' => '15',
            ...
            'category' => 'movies',
            'thumbnail' => base64_encode(file_get_contents('https://lumiere-a.akamaihd.net/v1/images/Star-Wars-New-Hope-IV-Poster_c217085b.jpeg?region=49%2C43%2C580%2C914'))
        ]);
        DB::table('products')->insert([
        ...
        DB::table('products')->insert([
            ...
            'category' => 'movies',
            'thumbnail' => base64_encode(file_get_contents('https://lumiere-a.akamaihd.net/v1/images/Star-Wars-Attack-Clones-II-Poster_53baa2e7.jpeg?region=18%2C0%2C660%2C1000&width=600'))
        ]);
        DB::table('products')->insert([
            ...
            'category' => 'movies',
            'thumbnail' => base64_encode(file_get_contents('https://lumiere-a.akamaihd.net/v1/images/Star-Wars-Phantom-Menace-I-Poster_3c1ff9eb.jpeg?region=15%2C9%2C651%2C979'))
        ]);
    }
}
